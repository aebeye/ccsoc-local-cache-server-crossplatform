module.exports = {
    ...
    "exponentialRetry":
    {
        "retryCount": 5, //Represents the client retry count
        "retryInterval": 60000, //Represents the maximum retry interval, in milliseconds
